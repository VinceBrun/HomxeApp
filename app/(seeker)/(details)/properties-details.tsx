/**
 * Property Details Screen (Seeker)
 * Full property information with images, amenities, reviews, and booking options
 */
      ...
      [
        {
          ...
          onPress: () => {
            ...
            const url = `whatsapp://send?phone=${landlord.phone_number}&text=${encodeURIComponent(
              message,
            )}`;
